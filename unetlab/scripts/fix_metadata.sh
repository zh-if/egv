...
FILES=$(fgrep -Rl "@author Alain Degreffe" html wrappers scripts)
...
#TODO  exiftool -owner='Andrea Dainese <andrea.dainese@gmail.com>' -copyright='Andrea Dainese <andrea.dainese@gmail.com>' -author='Eugenia Paffile <eugenia.paffile@gmail.com>' -comment='Part of UNetLab software (http://www.eve-ng.net/)' *
#TODO  exiftool -owner='Andrea Dainese <andrea.dainese@gmail.com>' -copyright='Alain Degreffe <eczema@ecze.com>

...
$statement = $db -> prepare("update users set role = 'admin' ;");
$statement -> execute();
$statement = $db -> prepare("delete  from users where username IN ( select username from pods where id > 1 ) ;");
$statement -> execute();
$statement = $db -> prepare("delete  from users where username IN ( select username from pods where id < 0 ) ;");
$statement -> execute();
